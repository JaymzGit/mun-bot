...
bot.on("message", async message => {
  ...
  if (message.content.toLowerCase() == "-yes" || message.content.toLowerCase() == "-vote yes") {
    if (message.member.roles.cache.some(role => role.name === 'UNHCR Delegates') || message.member.roles.cache.some(role => role.name === 'WMO Delegates') ||
        ...
        message.member.roles.cache.some(role => role.name === 'Admin') || message.member.roles.cache.some(role => role.name === 'Chair') ||
        message.member.roles.cache.some(role => role.name === 'Secretariat') || message.member.roles.cache.some(role => role.name === 'Secretary General')) {
